...
mult_func get_multiplication_function(std::string function_name){
    const int names_num = 13;
    std::string all_function_names[names_num]={"base", "base_omp", "row", "row_omp", "tr", "tr_omp", "tr_omp_simd", "strassen", 
    "opt_block", "block_transposed", "strassen", "strassen_omp", "strassen_rec_omp"};
    ...
    {all_function_names[7], strassen_matrix_mult},
    {all_function_names[8], optimal_block_matrix_mult},
    {all_function_names[9], b_transposed_block_matrix_mult},
    {all_function_names[10], strassen_matrix_mult},
    {all_function_names[11], strassen_matrix_mult_omp},
    {all_function_names[12], strassen_matrix_mult_rec_omp}
    };
    try{
